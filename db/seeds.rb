...
kevin = User.create!(email: 'kevin@chat.com', password: '123456')
ed = User.create!(email: 'ed@chat.com', password: '123456')
seb = User.create!(email: 'seb@chat.com', password: '123456')
